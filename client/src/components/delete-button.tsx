...
interface DeleteButtonData {
  id: string;
}

/* From Uiverse.io by Shubh0408 */ 
export const DeleteButton = ({ id }: DeleteButtonData) => {
  ...
  return (
    <button
      ...
      className="group relative flex h-10 w-10 flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-red-800 bg-red-600 hover:bg-red-700"
    >
      <svg
